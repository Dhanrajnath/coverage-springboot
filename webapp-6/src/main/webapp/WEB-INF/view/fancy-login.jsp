...
<body>
	...
	<br>
	    ...
	    <div style="font-size:160%;">
            ...
            If you are the user then your username and password is "user".
            </marquee>
	    </div>
		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-info">
				...
				<div data-toggle="tooltip" title="Sign In here!" style="padding-top: 30px" class="panel-body">
					...
					<!-- Login Form -->
					<!-- if we use form tag then it violates CSRF!!  -->
					<form:form action="${pageContext.request.contextPath}/authenticateTheUser" 
						...
						<!--
						if form tag is used then
						<input type="hidden"
						        name="${_csrf.parameterName}"
						        value="${_csrf.token}" />
						we must manually add the token ...
						-->
